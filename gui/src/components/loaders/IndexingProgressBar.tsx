...
const IndexingProgressBar = ({
  ...
  function getIndexingErrMsg(msg: string): string {
    if (
      ...
      return "The 'transformers.js' embeddingsProvider is currently unsupported in JetBrains. To enable codebase indexing, you can use any of the other providers described in the docs: https://trybanana.ai/walkthroughs/codebase-embeddings#embeddings-providers";
    }
    return msg;
  }
