...
export const providers: Partial<Record<ModelProvider, ProviderInfo>> = {
  BananaAI_server: {
    title: "BananaAI Server",
    provider: "BananaAI_server",
    refPage: "BananaAI_server",
    description:
    ...
    packages: [models.BananaAI_model],
  },
  other: {
    title: "Other",
    provider: "other",
  ...
  azure: {
    ...
    longDescription: `[Visit our documentation](https://trybanana.ai/reference/Model%20Providers/azure) for information on obtaining an API key.
...
After it's up and running, you can start using BananaAI.`,
    icon: "llamacpp.png",
    tags: [ModelProviderTags.Local, ModelProviderTags.OpenSource],
    packages: openSourceModels,
    collectInputFor: [...completionParamsInputsConfigs],
