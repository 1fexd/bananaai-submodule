        ...
        if (!getLocalStorage("shownProfilesIntroduction")) {
          ...
          dispatch(
            setDialogMessage(
              <ConfirmationDialog
                text={
                  "Welcome to BananaAI for teams! Using the toggle in the bottom right, you can switch between your local profile (defined by config.json) and team profiles (defined in the BananaAI for teams web app). Each profile defines a set of models, slash commands, context providers, and other settings to customize BananaAI."
                }
    ...
    dispatch(
      setDialogMessage(
        <ConfirmationDialog
          ...
          text={"Are you sure you want to log out of BananaAI?"}
          onConfirm={() => {
