...
(async () => {
  ...
  // Modify and copy for .BananaAIrc.json
  ...
  schema.definitions.SerializedContinueConfig.properties.mergeBehavior = {
    ...
    markdownDescription:
      "If set to 'merge', .BananaAIrc.json will be applied on top of config.json (arrays and objects are merged). If set to 'overwrite', then every top-level property of .BananaAIrc.json will overwrite that property from config.json.",
  };
