...
```json title=~/.BananaAI/config.json
{
...
1. Make sure you have the "Enable Tab Autocomplete" setting checked (in VS Code, you can toggle by clicking the "BananaAI" button in the status bar).
...
6. Check the output of the logs to find any potential errors (cmd/ctrl+shift+p -> "Toggle Developer Tools" -> "Console" tab in VS Code, ~/.BananaAI/core.log in JetBrains).
7. If you are still having issues, please let us know in our [Discord](https://discord.gg//XndZet2pWF) and we'll help as soon as possible.
...
Click the "BananaAI" button in the status panel at the bottom right of the screen. The checkmark will become a "cancel" symbol and you will no longer see completions. You can click again to turn it back on.

Alternatively, open VS Code settings, search for "BananaAI" and uncheck the box for "Enable Tab Autocomplete".

### JetBrains

Open Settings -> Tools -> BananaAI and uncheck the box for "Enable Tab Autocomplete".

### Feedback

If you're turning off autocomplete, we'd love to hear how we can improve! Please let us know in our [Discord](https://discord.gg//XndZet2pWF) or file an issue on GitHub.
