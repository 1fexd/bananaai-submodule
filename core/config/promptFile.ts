...
# It is used to define and reuse prompts within BananaAI
# BananaAI will automatically create a slash command for each prompt in the .prompts folder
# To learn more, see the full .prompt file reference: https://trybanana.ai/features/prompt-files
temperature: 0.0
---
{{{ diff }}}
